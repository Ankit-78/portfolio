...
const Projects: React.FC = () => {
  const projects = [
    ...
    },
    {
      ...
      description: "A MERN-based application that allows users to upload files and share them via a generated link. Features file preview, download, and secure access.",
      tech: ["React.js", "Node.js", "Express.js", "MongoDB", "Tailwind CSS"],
      liveDemo: "https://mern-fileshare-five.vercel.app/",
      github: "https://github.com/Ankit-78/mern-fileshare",
